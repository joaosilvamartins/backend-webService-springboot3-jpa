...
public class TestConfig implements CommandLineRunner{
	...
	@Autowired
	private OrderItemRepository orerItemRepository;
	...
	public void run(String... args) throws Exception {
		...
		Product p3 = new Product(null, "PC Gamer", "Donec liquet odio ac rhoncus cursus.", 1200.0, "");
		Product p4 = new Product(null, "Rails for Dummies", "Cras fringilla convallis sem vel faucibus", 100.99, "");
		
		categoryRepository.saveAll(Arrays.asList(cat1, cat2, cat3));
		productRepository.saveAllAndFlush(Arrays.asList(p1, p2, p3, p4));
		...
		orerItemRepository.saveAll(Arrays.asList(oi1, oi2, oi3, oi4));
